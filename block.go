...
// Tx returns a wrapped transaction (dashutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (dashutil.Tx) for all
...
// instead provides easy access to wrapped versions (dashutil.Tx) of them.
