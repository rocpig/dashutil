...
import (
	...
	"github.com/rocpig/dashutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    dashutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() dashutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value dashutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = dashutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = dashutil.NewTxFromBytes(testSimpleCoinTxBytes)
